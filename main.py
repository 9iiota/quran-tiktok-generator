...
class TikToks:
    ...
    def muhammad_al_luhaidan_al_ahqaf_30_31(self) -> None:
        """
        Modifies the parameters of the class for a TikTok video for verses 30-31 of Surah Al-Ahqaf by Muhammad Al-Luhaidan
        """
