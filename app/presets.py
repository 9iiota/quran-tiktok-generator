...
class Presets(Enum):
    ...
    ARI_MOHAMMED_AL_KURDI_ASH_SHUARA_221_227 = Preset(
        r"Surahs\Ari Mohammed Al-Kurdi\Ash-Shu'ara (26.221-227)",
        (221, 227),
    )
    ...
    MUHAMMAD_AL_LUHAIDAN_AL_AHZAB_69_73 = Preset(
        r"Surahs\Muhammad Al-Luhaidan\Al-Ahzab (33.69-73)",
        (69, 73),
    )
    ...
    MUHAMMAD_AL_LUHAIDAN_AL_MUTAFFIFIN_18_28 = Preset(
        r"Surahs\Muhammad Al-Luhaidan\Al-Mutaffifin (83.18-28)",
        (18, 28),
    )
    ...
    MUHAMMAD_AL_LUHAIDAN_LUQMAN_14_15 = Preset(
        r"Surahs\Muhammad Al-Luhaidan\Luqman (31.14-15)",
        (14, 15),
    )
    ...
    OMAR_BN_DIAAALDEEN_YUNUS_89_90 = Preset(
        r"Surahs\Omar Bn DiaaAldeen\Yunus (10.89-90)",
        (89, 90),
    )
    ...
    YASSER_AL_DOSARI_AL_ANAM_147_149 = Preset(
        r"Surahs\Yasser Al-Dosari\Al-An'am (6.147-149)",
        (147, 149),
    )
    YASSER_AL_DOSARI_AL_FALAQ_1_5 = Preset(
        r"Surahs\Yasser Al-Dosari\Al-Falaq (113.1-5)",
        (1, 5),
    )
    ...
    YASSER_AL_DOSARI_AL_JUMUAH_8 = Preset(
        r"Surahs\Yasser Al-Dosari\Al-Jumu'ah (62.8)",
        (8),
    )
    ...
    YASSER_AL_DOSARI_MARYAM_59_65 = Preset(
        r"Surahs\Yasser Al-Dosari\Maryam (19.59-65)",
        (59, 65),
    )
    ...
    YOUNES_RAHMAN_HUD_89_90 = Preset(
        r"Surahs\Younes Rahman\Hud (11.89-90)",
        (89, 90),
    )
